...
between estimations of correlation for difference levels of the two factors: $\chi^2(5) = 91.91, p <.001$.
...
We do this using the ```rescale_mid``` function from the ```scales``` package. 
...
knitr::include_graphics(c("trial.png", "set_to_1_AC.png"))
```
